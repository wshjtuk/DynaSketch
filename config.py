...
def parse_arguments():
    ...
    parser.add_argument("--name", type=str, default="video", help="name")
    ...
    parser.add_argument("--frame_cut", type=int, default=10)
    # =================================
    # ============ wandb ============
    # =================================
    parser.add_argument("--use_wandb", type=int, default=0)
    parser.add_argument("--wandb_user", type=str, default="ucas2023")
    parser.add_argument("--wandb_name", type=str, default="clipasso")
    ...
    parser.add_argument("--control_point_loss", type=float, default=1)
    parser.add_argument("--bezier_loss", type=float, default=1)
    parser.add_argument("--track_loss", type=float, default=1)
    ...
    parser.add_argument("--control_point_weight", type=float, default=0.0001)
    parser.add_argument("--bezier_weight", type=float, default=0.01)
    parser.add_argument("--track_weight", type=float, default=0.02)
    # =================================
    # ============= track =============
    # =================================
    ...
    # parser.add_argument("--origin_file_name", type=str, default="test1")
    # parser.add_argument("--final_file_name", type=str, default="test2")
